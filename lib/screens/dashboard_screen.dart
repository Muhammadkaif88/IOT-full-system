...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void _onDeviceTap(Device d) {
    if (d.type == 'led') {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (_) => const WaterTankScreen()));
    } else {
    ...
    return Row(
      children: [
        ...
        Stack(clipBehavior: Clip.none, children: [
          ...
          Positioned(top: 8, right: 8, child: Container(width: 8, height: 8, decoration: const BoxDecoration(color: Color(0xFFE24B4A), shape: BoxShape.circle))),
        ]),
        const SizedBox(width: 4),
        const CircleAvatar(radius: 18, backgroundColor: Color(0xFF6C63FF), child: Text('MK', style: TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.w600))),
      ],
    );
  }
  ...
  Widget _buildStatusCard() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(color: const Color(0xFF1A1A2E), borderRadius: BorderRadius.circular(14), border: Border.all(color: Colors.white10)),
      child: Column(children: [
        ...
        Row(children: [
          ...
          _statTile('--', 'Tank', const Color(0xFF378ADD)),
